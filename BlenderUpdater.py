...
def main():
    ...
    dark_palette.setColor(dark_palette.Base, QtGui.QColor(25, 25, 25))
    dark_palette.setColor(dark_palette.AlternateBase, QtGui.QColor(53, 53, 53))
    ...
    dark_palette.setColor(dark_palette.HighlightedText, QtGui.QColor(0, 0, 0))
    dark_palette.setColor(dark_palette.Disabled, dark_palette.Text,
